package com.cyh.bigimageloader.map;
...
import com.cyh.bigimageloader.view.InputStreamScene;
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            if (scaleFactor != 0f && scaleFactor != 1.0f) {
                ...
                scene.getViewport().zoom(scaleFactor, screenFocus);
                invalidate();
            }
    ...
    class Touch {
        ...
        boolean fling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            synchronized (this) {
                ...
                scroller.fling(fling_viewOrigin.x, fling_viewOrigin.y, (int) -velocityX, (int) -velocityY, 0, fling_sceneSize.x - fling_viewSize.x, 0, fling_sceneSize.y - fling_viewSize.y);
                touchThread.interrupt();
            }
